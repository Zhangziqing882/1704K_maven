...
<center>
		...
		<input type="hidden" name="id" value="${zw.id}">
			名称:<input type="text" name="name" value="${zw.name}" readonly="readonly"><br>
			描述:<input type="text" name="show" value="${zw.show}" readonly="readonly"><br>
			类别:<select name="tid" disabled="disabled">
			</select><br>
